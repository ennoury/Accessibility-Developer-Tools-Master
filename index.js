(function (root, client) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ArvatoInventoryService = client(root.popsicle);
  }
  ...
  function Resource0 (uri, client) {
    ...
    this.sources = new Resource1(uri + '/sources', client);
  };
  ...
  Resource1.prototype.sourceId = function (/* ...args */) {
  ...
  function Resource2 (uri, client) {
    ...
    this.batches = new Resource3(uri + '/batches', client);
    this.stocks = new Resource5(uri + '/stocks', client);
  };
  ...
  function Resource3 (uri, client) {
    ...
    this.stocks = new Resource4(uri + '/stocks', client);
  };
  ...
  Resource5.prototype.sku = function (/* ...args */) {
    var uri = this._uri + template('/{0}', arguments, [undefined]);
  ...
  function Resource6 (uri, client) {
    ...
    this.transactions = new Resource7(uri + '/transactions', client);
  };
  ...
  function Client (options) {
    this.options = extend({
      baseUri: 'https://{baseUri}/tenants/{tenant}',
      baseUriParameters: {baseUri:'api.yaas.io/arvato/inventory/test',tenant:undefined}
    }, options);
